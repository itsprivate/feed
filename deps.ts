...
// npm modules
export { getMetadata } from "npm:page-metadata-parser@1.1.4";
// export { default as slug } from "https://jspm.dev/slug@6.0.0";
import { slugify } from "npm:transliteration@2.3.5";
...
export { default as jsonfeedToAtom } from "npm:jsonfeed-to-atom@1.2.4";
export { default as jsonfeedToRSS } from "npm:jsonfeed-to-rss@3.0.7";
export { default as tweetPatch } from "npm:tweet-patch@2.0.5";
